...
```{r}
  ...
  save.image("~/Genexpi/genexpi/rpackage/.RData")
```
...
```{r}
  ...
  cat(paste0("Raw time per round (on ", numCoresUsed," cores): ", aracneRawTimePerRound_r / 60, " minutes\n"))
  cat(paste0("Splined time per round (on ", numCoresUsed," cores): ", aracneSplinedTimePerRound_r / 60, " minutes\n"))
...
```{r}
  ...
  cat(paste0("Raw time per round (on ", numCoresUsed," cores): ", aracneRawTimePerRound_r_kim / 60, " minutes\n"))
  cat(paste0("Splined time per round (on ", numCoresUsed," cores): ", aracneSplinedTimePerRound_r_kim / 60, " minutes\n"))
...
Most values are duplicated, since for the regulon of Kallifidas et al., at most one target was removed by Genexpi.
